...
async function test() {
  try {
    let token = '';
    try {
      const regRes = await axios.post('https://starbugs-backend.onrender.com/api/auth/register', {
    ...
    const res = await axios.get('https://starbugs-backend.onrender.com/api/products', {
